...
net = cv2.dnn.readNet('C:/ml_assignment/yolov3.weights', 'C:/ml_assignment/yolov3.cfg')
classes = []

with open('C:/ml_assignment/coco.names') as f:
...
for i in os.listdir('C:/ml_assignment/static/images/'):
    # print(i)
    
    img = cv2.imread('C:/ml_assignment/static/images/'+i)
...
def get_obj(): 
    ...
    mydoc =  mycol.find(q)
    for x in mydoc:  
        path = 'C:/ml_assignment/static/images/'+x['image_name']
        return '<img alt=obj ,width="500", height="600",src='+path+'></img>'
